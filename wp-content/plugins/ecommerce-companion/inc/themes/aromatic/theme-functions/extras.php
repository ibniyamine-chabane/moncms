	...
	return apply_filters(
		'aromatic_get_testimonial3_default', json_encode(
				...
				array(
					...
					'title'           => esc_html__( 'Penelope Aria', 'aromatic-pro' ),
					'subtitle'           => esc_html__( 'Chief Executive Officer', 'aromatic-pro' ),
					'text'            => esc_html__( 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet, accusamus? Id eveniet reprehenderit aliquam, in error iure odit obcaecati aspernatur consequuntur corrupti eos doloribus? Ipsam neque nihil aliquam ut  voluptas.', 'aromatic-pro' ),
