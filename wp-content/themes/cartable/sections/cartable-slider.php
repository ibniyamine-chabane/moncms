<?php 
	$cartable_hs_slider		= get_theme_mod('hide_show_slider','on');
	if( $cartable_hs_slider == 'on' ): 
?>
...
<?php if(!empty($id_arr))
{ ?>
	<section id="slider-section" class="slider-wrapper slider-section-eighteen">
		<div class="main-slider arrows-small arrows-transparent">
			...
			<div class="item">
				...
				<div class="specia-slider <?php echo esc_attr(get_post_meta( get_the_ID(),'slider_caption_align', true)); ?>" style="background: rgba(0,0,0,0);">
